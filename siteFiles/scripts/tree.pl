...
$conf::templatefile = "/home/u426355/v-va.ru/www/siteFiles/scripts/tree-template.shtml";	# The template (set to "" to disable it)
...
@conf::excludefiles = ('/siteFiles/*', '/olgabraytsara/*', '/print/images/*', '/includes/*', '*/images/', '/promo/promoFiles/*', '/paydone.shtml', '/sitemap.shtml', '*empty*', '/ap/*');
...
$conf::link =<<EOF;
<a href="URL">TITLE</a> UPDATED <span class="info"></span>
EOF
